...
void myNavigator(struct MyNavigator* myNavigator)
{
	...
	// Сигнализируем, что пришло сообщение с координатами (включением синего светодиода) (Уряяя!) :
...
// Альфа-бета фильтр :
	...
	// Сигнализируем, что функция фильтрации выполнена успешно (выключением синего светодиода) :
